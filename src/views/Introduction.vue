        ...
        <ul class="swiper-wrapper">
            ...
            <div class="content">
              <div class="article">
                ...
                <div class="paragraph">
                  <h2>吉市分期产品简介</h2>
                  <p>
                    吉市分期整合了全国27家商业银行、支付宝等金融机构信用产品，为商户提供一站式的分期产品定制服务；可为终端消费者提供0手续费的优质分期服务。
                  </p>
                  <h2>核心竞争力</h2>
                  <ul class="rules">
              ...
              <div class="picture">
                <img
                  src="../image/introduction/introduction_slider_1.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <li class="swiper-slide page2" :class="getActiveClass(1)">
            <div class="content">
              <div class="picture">
                <img
                  src="../image/introduction/introduction_slider_2.png"
                  alt=""
                />
              </div>
              <div class="article">
                ...
                <div class="paragraph">
                  ...
                  <dl>
                    <dt>服务方式：</dt>
                    <dd>
                      免费向商户提供支付平台技术接入，多种支付渠道供C端消费者选择
                    </dd>
                  </dl>
                  <dl>
                    <dt>平台优势：</dt>
                ...
                <h2>吉市分期亮点</h2>
                <p class="hint">
                  产品质量是根本、免息分期无感支付是亮点，让我们联合给客户不一样的购物体验。
                </p>
                <ul class="rules">
                  <li>商户可选择对产品可分期期数自主多元化选择</li>
                  <li>
                    有商户自由分期手续费补贴，同时，可自由选择全期数补贴和部分期数补贴
                  </li>
                  <li>现有支付方式;花呗、信用卡（国内主流银行）</li>
                  <li>
                    开发中的新支付方式：在线无卡申请消费额度，0秒批额即可使用
                  </li>
                </ul>
              </div>
            </div>
          ...
          <li class="swiper-slide page3" :class="getActiveClass(2)">
            <div class="content">
              <div class="picture">
                <img
                  src="../image/introduction/introduction_slider_3.jpg"
                  alt=""
                />
              </div>
              <div class="article">
                <h1>
                  <img
                    src="../image/introduction/introduction_title_2.png"
                    alt=""
                  />
                </h1>
                <h2>百保箱产品简介</h2>
  ...
  methods: {
    ...
    perspactive(event) {
      ...
      for (let i = 0; i < oLi.length; i++) {
        ...
        oLi[i].style.transform =
          "translate(" +
          marginLeft * zIndex * this.footerRandomDictionary[i] +
          "px," +
          marginTop * zIndex * -this.footerRandomDictionary[i] +
          "px)";
      }
      for (let i = 0; i < oLi2.length; i++) {
        let zIndex = window.getComputedStyle(oLi2[i]).zIndex;
        oLi2[i].style.transform =
          "translate(" +
          marginLeft * zIndex * -this.topRandomDictionary[i] +
          "px," +
          marginTop * zIndex * this.topRandomDictionary[i] +
          "px)";
      }
    },
  },
